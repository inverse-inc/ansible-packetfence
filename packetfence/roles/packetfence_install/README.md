...
| `packetfence_install__centos_release_rpm`      | `"http://packetfence.org/downloads/PacketFence/RHEL7/packetfence-release-el7.stable.noarch.rpm"` | URL to install `centos_release_pkg`                                     |
